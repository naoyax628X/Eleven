...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("Eleven", Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("Eleven");
#endif
    ...
    FileUtils::getInstance()->addSearchPath("reult");
    
    // create a scene. it's an autorelease object
    TwelveGameSceneData * data { TwelveGameSceneData::create() };
    
    TwelveGameScene* scene = TwelveGameScene::create(data);
